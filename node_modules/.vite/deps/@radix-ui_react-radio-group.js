...
var Slot2 = React7.forwardRef((props, forwardedRef) => {
  ...
  if (slottable) {
    ...
    return (0, import_jsx_runtime5.jsx)(SlotClone2, { ...slotProps, ref: forwardedRef, children: React7.isValidElement(newElement) ? React7.cloneElement(newElement, void 0, newChildren) : null });
  }
...
var Radio = React21.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime11.jsxs)(RadioProvider, { scope: __scopeRadio, checked, disabled, children: [
...
var RadioIndicator = React21.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime11.jsx)(Presence, { present: forceMount || context.checked, children: (0, import_jsx_runtime11.jsx)(
      Primitive.span,
      {
...
var RadioGroupIndicator = React22.forwardRef(
  (props, forwardedRef) => {
    ...
    const radioScope = useRadioScope(__scopeRadioGroup);
    return (0, import_jsx_runtime12.jsx)(RadioIndicator, { ...radioScope, ...indicatorProps, ref: forwardedRef });
  }
);
